...
class PollutionRepository{
  String endpoint='https://www.data.corsica/api/records/1.0/search/?dataset=query-outfields-and-where-1-3d1-and-f-geojson&q=&rows=4000&facet=nom_dept&facet=nom_com&facet=nom_station&facet=x_l93&facet=y_l93';
